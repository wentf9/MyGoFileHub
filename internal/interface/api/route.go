...
func InitRouter(fileService *application.FileService, authService *application.AuthService, userService *application.UserService, sourceService *application.SourceService) *gin.Engine {
	r := gin.Default()
	// ---------------------------------------------------------
	// 关闭 Gin 的自动重定向
