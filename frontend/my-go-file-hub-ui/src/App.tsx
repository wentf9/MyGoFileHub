...
import { Plus, X, Folder, HardDrive, Settings, Monitor, ChevronRight, File, Image, Video, FileText, Loader2 } from "lucide-solid";
  ...
  return (
    <div class="flex flex-col h-screen w-full bg-slate-50 text-slate-900 select-none">
      ...
      <header class="h-10 flex items-center px-4 bg-white border-b border-slate-200 gap-4">
        ...
        <button class="p-1 hover:bg-slate-100 rounded text-slate-500">
          <Settings size={18} />
        </button>
      </header>
